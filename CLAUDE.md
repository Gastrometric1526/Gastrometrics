...
2. El documento de auditoría con el número más alto en `docs/` (a la fecha de este commit: `docs/53-plantillas-correo-migracion-testers-y-planes.md`) — es la fuente de verdad sobre qué está hecho, qué falta, y dónde. **No confíes en él sin verificar contra el código real** — es la regla que se ha seguido en todo el proyecto.
