  ...
  en: {
    ...
    "chef-de-partie": {
      ...
      features: [
        ...
        "Manual sales entry (no POS needed)",
      ],
  ...
  da: {
    ...
    "chef-de-partie": {
      ...
      features: [
        ...
        "Manuel registrering af salg (uden POS)",
      ],
  ...
  fr: {
    ...
    "chef-de-partie": {
      ...
      features: [
        ...
        "Saisie manuelle des ventes (sans caisse POS)",
      ],
  ...
  pt: {
    ...
    "chef-de-partie": {
      ...
      features: [
        ...
        "Registro manual de vendas (sem precisar de um POS)",
      ],
